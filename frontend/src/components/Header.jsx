...
export default function Header() {
  return (
    <header className="sticky top-0 z-20 bg-transparent px-4 sm:px-6 py-4 flex items-center justify-between">
      <div className="flex items-center gap-4 min-w-0">
        ...
        <div className="relative w-full max-w-2xl">
          <input placeholder="Search anything... (Ctrl + K)" className="w-full rounded-3xl bg-white/90 px-4 py-2 pr-12 text-sm outline-none" />
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-white/10 text-white">💬</button>
        <div className="flex items-center gap-3 rounded-3xl bg-white/90 px-3 py-2 ring-1 ring-white/60">
          <img src="/avatar.png" alt="User" className="h-9 w-9 rounded-full object-cover" />
