...
import { Bell, Menu, MoonStar, Search, SunMedium, Sparkles } from 'lucide-react'
    ...
    <header className="sticky top-0 z-30 border-b border-white/10 bg-white/70 backdrop-blur-xl dark:bg-slate-950/60">
      <div className="flex items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-blue-600 dark:text-blue-300">BachelorGhor SaaS</p>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white/90 px-3 py-2 shadow-sm dark:border-slate-800 dark:bg-slate-900/80">
