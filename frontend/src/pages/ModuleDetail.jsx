  ...
  if (!module) {
    return (
      <div className="rounded-3xl border border-white/70 bg-white/85 p-8 shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
        <h2 className="text-2xl font-semibold text-slate-950">Module not found</h2>
        <p className="mt-2 text-slate-600">The requested module does not exist in the catalog.</p>
